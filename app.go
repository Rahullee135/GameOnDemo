...
// // 1. cpu metric
// func (a *App) CpuMetric(appNames string) string {
...
// 1
// login api
func (a *App) MyLogin(req string) string {
...
// 4 open app
func (a *App) OpenApp(appName string) string {

	return L.AppOpen(appName)
}

// basic information
func (a *App) BasicInfo(appInfoData string) string {
...
// start scan
func (a *App) StartScan(appNameTest string, valData string) string {
...
// stop scan
func (a *App) StopScan(appInfoData string, valData string) string {
	sec := map[string]string{}
	if err := json.Unmarshal([]byte(appInfoData), &sec); err != nil {
		return fmt.Sprintf("error while unmarshalling data: %v", err)
	}
...
// 2. memory metric
func (a *App) MemoryMetric(appNames string) string {
...
// 3. gpuMetric
func (a *App) GpuMetric(appNames string) string {
	//L.AppGPUUsage(appNames)
	res2 := L.AppGPUUsage(appNames)
	currentactiviy := L.GetCurrentActivity(appNames)
...
func (a *App) UploadData(appName string) string {
...
// 5. download data
func (a *App) DownloadedData(appName string) string {
...
// 6. cpu cores
func (a *App) CpuCores(appNames string) string {
...
// 7. power usage
func (a *App) PowerMetric(appNames string) string {
...
// 8 App power metric
func (a *App) AppPowerMetric(appNames string) string {
...
//screenshot
func (a *App) Screenshot(appNames string) string {
...
// 9. CPU architecture
func (a *App) CpuArch(appNames string) string {
...
func (a *App) AvgFPSStablity(appName string) string {
...
func (a *App) Peakmomery(appName string) string {
...
func (a *App) AvgMedianFPS(appName string) string {
...
func (a *App) Display(appNames string) string {
...
// 12 Mobile Network
func (a *App) MobileNetwork(appNames string) string {
